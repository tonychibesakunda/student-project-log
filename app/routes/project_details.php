...
$app->get('/project_details/:id', function($supervisionID) use ($app){
	...
	$app->render('project_details.php',[
...
$app->post('/project_details/:id', function($supervisionID) use ($app){

})->name('project_details.post');