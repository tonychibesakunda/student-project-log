...
$app->get('/coordinator/projects/view_project_details/:id', $coordinator(), function($supervisionID) use($app){
	...
	$app->render('coordinator/projects/view_project_details.php', [
		'project_details' => $project_details,
		'project_objectives' => $project_objectives,
		'tasks' => $tasks
	]);

})->name('coordinator.view_project_details');

$app->post('/coordinator/projects/view_project_details/:id', $coordinator(), function($supervisionID) use($app){
...
})->name('coordinator.view_project_details.post');