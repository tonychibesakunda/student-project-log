...
{% block content %}
	...
	<div class="container-fluid text-center">
		<div class="row content">
			<div class="col-sm-12">
				<h1><p style="font-family: Courier New;"><b>Welcome, Head Of Department</b></p></h1>
			</div>
			<div class="col-sm-3">
				...
				<div class="panel panel-default">
				  ...
				  <div class="panel-footer"><a href="{{ urlFor('hod.view_assigned_students') }}">View More...</a></div>
				</div>	
			</div>
			<div class="col-sm-6">
				<div class="panel panel-default">
				  ...
				  <div class="panel-footer"><a href="{{ urlFor('hod.view_projects') }}">View More...</a></div>
				</div>
			</div>
			<div class="col-sm-3">
				<div class="panel panel-default">
