...
{% block title %}Edit Supervisor{% endblock %}
...
{% block content %}
    ...
    <div class="row content"><br>
        ...
        <div class="col-sm-8  text-left" id="container">
            ...
            {% for row in userInfo %}
            <form action="{{ urlFor('coordinator.edit_supervisor.post', {id: row.id}) }}" method="POST" autocomplete="off">
            {% endfor %}
<fieldset>
            <legend class="text-center">Edit Supervisor Account</legend>
            <div class="col-sm-6">
            ...
            <div class="col-sm-12">
                ...
                <button type="submit" class="btn btn-link" name="back"><a href="{{ urlFor('coordinator.view_supervisor') }}">&larr; Back</a></button>
        ...
        <div class="col-sm-2 sidenav">
            <div class="well">
                ...
                <p>This section is used for editing supervisors to the system</p>
            </div>
        </div>
