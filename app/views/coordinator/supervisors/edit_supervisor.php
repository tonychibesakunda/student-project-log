...
{% block content %}
    ...
    <div class="row content"><br>
        ...
        <div class="col-sm-8  text-left" id="container">
            ...
            <form action="{{ urlFor('coordinator.edit_supervisor.post') }}" method="POST" autocomplete="off">
...
<fieldset>
            ...
            <div class="col-sm-12">
                ...
                <button type="submit" class="btn btn-link"><a href="{{ urlFor('coordinator.view_supervisor') }}">&larr; Back</a></button>
