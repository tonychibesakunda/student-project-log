...
{% block title %}Add Supervisor{% endblock %}
...
{% block content %}
    ...
    <div class="row content"><br>
        ...
        <div class="col-sm-8  text-left" id="container">
            ...
            <form action="{{ urlFor('coordinator.add_supervisor.post') }}" method="POST" autocomplete="off">
            
<fieldset>
            <legend class="text-center">Add Supervisor Account</legend>
            <div class="col-sm-6">
        ...
        <div class="col-sm-2 sidenav">
            <div class="well">
                ...
                <p>This section is used for adding supervisors to the system</p>
            </div>
        </div>
