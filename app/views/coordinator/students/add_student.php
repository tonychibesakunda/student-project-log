...
<fieldset>
            ...
            <div class="col-sm-6">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="first_name" aria-describedby="firstNameHelp" placeholder="Enter first name" name="first_name"{% if request.post('first_name') %} value="{{request.post('first_name')}}" {% endif %} required>
                    {% if errors.has('first_name')%}<small class="form-text text-muted" style="color: red;">{{errors.first('first_name')}}</small>{% endif %}
                </div>
                <div class="form-group">
                    <label for="last_name">Last Name:</label>
                    <input type="text" class="form-control" id="last_name" aria-describedby="lastNameHelp" placeholder="Enter last name" name="last_name"{% if request.post('last_name') %} value="{{request.post('last_name')}}" {% endif %} required>
            ...
            <div class="col-sm-6">
                ...
                <div class="form-group">
                    ...
                    <input type="email" class="form-control" id="email" aria-describedby="emailHelp" placeholder="Enter email" name="email"{% if request.post('email') %} value="{{request.post('email')}}" {% endif %} required>
